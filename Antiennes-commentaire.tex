...
%\let\red\rubrum
    ...
    \redlines
    %\definecolor{gregoriocolor}{rgb}{\rubrum}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
...
\titre{19 décembre}
\vulgo{O Fils de la race de Jessé, signe dresse devant les peuples, vous devant qui les souverains resteront silencieux, vous que les peuples appelleront au secours, délivrez-nous, venez, ne tardez plus !}
...
\versio{Pr\'æsta, quaésumus, omnípotens
Deus: ut redemptiónis
nostræ ventúra sollémnitas et
præséntis nobis vitæ subsídia
cónferat, et ætérnæ beatitúdinis
praémia largiátur. Per Dóminum}{Faites, nous vous le demandons, Seigneur : que la solennité approchant de notre rédemption nous apporte avec elle les grâces nécessaires pour la vie présente et nous obtienne la récompense du bonheur éternel.}
